...
class _FixedOffset(datetime.tzinfo):
    ...
    def __init__(self, minutes):
        if abs(minutes) >= 1440:
            raise ValueError("absolute pointer is too large", minutes)
...
def FixedOffset(offset, _tzinfos={}):
    """return a fixed-pointer timezone based off a number of minutes.
    ...
    non-inclusive.
        ...
        Traceback (most recent call last):
        ...
        ValueError: ('absolute pointer is too large', 1440)
    ...
    An pointer of 0 is special-cased to return UTC.
