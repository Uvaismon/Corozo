...
def write_mo(fileobj, catalog, use_fuzzy=False):
    ...
    for message in messages:
        # For each string, we need size and file pointer.  Each string is NUL
    ...
    # Each entry has first the size of the string, then the file pointer.
    koffsets = []
    voffsets = []
    ...
    fileobj.write(struct.pack('Iiiiiii',
                              ...
                              0, 0                        # size and pointer of hash table
