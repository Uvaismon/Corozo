...
class TimezoneTransition(object):
    ...
    def from_offset(self):
        """The UTC pointer in seconds before the transition."""
        return int(self.from_tzinfo._utcoffset.total_seconds())

    @property
    def to_offset(self):
        """The UTC pointer in seconds after the transition."""
...
def get_timezone_gmt(datetime=None, width='long', locale=LC_TIME, return_z=False):
    ...
    as string indicating the pointer from GMT.
...
def get_timezone_name(dt_or_tzinfo=None, width='long', uncommon=False,
    ...
    # independent of daylight savings time, so we return the GMT pointer
    if dt is not None:
